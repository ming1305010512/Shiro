...
<body>
    ...
    <ul>
        <li>You may <shiro:lacksPermission name="user:delete"><b>NOT</b> </shiro:lacksPermission> command the <code>user:delete</code> Starship!</li>
        <li>You may <shiro:lacksPermission name="user:${account}:select"><b>NOT</b> </shiro:lacksPermission> edit the ${account} user!</li>
    </ul>
